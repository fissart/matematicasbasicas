...
$$ p \wedge q \equiv q \wedge p  \equiv \sim(\sim p \vee \sim q )\equiv \sim (p\rightarrow \sim q)$$
...
$$ \begin{aligned}
    w &=\int_{1}^{3}\\
     &=\sum_{1}^{3}\lim_{x \to \infty} \prod_{n=1}^{\infty }\sum_{1}^{3}\sum_{n=1}^{\infty }\\
\end{aligned}  $$
...
$$
esto es $\epsilon_1$ $$ \begin{aligned}
    w &=w\\
     &=wwwwwwwwwwwwwwwwwwwww_1\\
\end{aligned}  $$ 
...
$$
$$ \sum_{n=i}^{3}\int_{1}^{3} x_2y_2z_3 r \sum_{w}^{w} $$
