...
\toprule
\(p\) & \(q\) & \$w \rightarrow \left( \sim p \right) \$ & \(w\)\tabularnewline
\midrule
\endhead
V & V & &\tabularnewline
V & F & &\tabularnewline
...
\end{definition}
\begin{definition}[www]
\protect\hypertarget{def:float}{}{\label{def:float} \iffalse (www) \fi{} }wwwwwwwwwwwwwwwwwwww
\end{definition}
